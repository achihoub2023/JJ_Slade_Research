...
#SBATCH --output=Multiview_Results/slurm.%N.%j.out  # STDOUT output file

#SBATCH --error=Multiview_Results/slurm.%N.%j.err   # STDERR output file (optional)

module use /projects/community/modulefiles
module load py-data-science-stack/5.1.0-kp807
module load python/3.8
python3.8 Multiview_Learning.py
